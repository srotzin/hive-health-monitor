...
const DID='did:hive:hiveforce-healthmon';const ID={name:'HiveForce-HealthMonitor',purpose:'Infrastructure health monitoring — uptime, latency, anomaly detection, alerting',capabilities:["uptime_monitoring","latency_tracking","anomaly_detection","alert_routing"],did:DID};
...
async function registerWithHiveGate(){return p(`${G}/v1/gate/onboard`,{agent_name:'hive-health-monitor',purpose:ID.purpose})}
